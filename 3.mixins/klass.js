// Quiero crear un modulo con lo q habia en soluciones/tema1
// - que Class no sea global => meterlo en funcion
...
var ProJS = (function(my){
  ...
  Class.extend = function(prop) {
    ...
    Klass.mixin = function(module){
      for (var k in module){
        if(!(k in Klass.prototype)) {
          Klass.prototype[k] = module[k];
        }
      }
      if(module.mixed){
        module.mxed(this);
...
var InstanceModule = {
  diHola: function(){console.log("HOLA");},
  mixed: function(klass){
    console.log('MISEC')
  }
};

var MiClase = ProJS.Class.extend({
  init: function() {},
});
